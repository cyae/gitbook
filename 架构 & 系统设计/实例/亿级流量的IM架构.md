...
双ID链方法:​[Raft -论文导读 与 ETCD源码解读](https://hardcore.feishu.cn/docs/doccnMRVFcMWn1zsEYBrbsDf8De)​​
...
1.  下行消息不需要ack机制，服务端不需要维护超时重发逻辑​

2.  可通过一次拉取所有会话消息列表，减少网络调用次数​

3.  批量拉取利于对消息进行压缩，提高带宽利用率​
...
上行消息在频发发送消息的场景下容易造成网络用塞​

​

​

![](blob:https://bytedancecampus1.feishu.cn/c697b532-fdd7-46e8-9756-075346c0e1c3)
...
![](blob:https://bytedancecampus1.feishu.cn/9af36884-0d79-47f3-af0f-523bcf824b80)
